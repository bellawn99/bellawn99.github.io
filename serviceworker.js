//karena di javascript itu single treads jadi dia jalannya bareng2, jadi biar proses 2, 3, dst turun dikit maka mesti dikasih waitUntil, biar dia ada jedanya sampe dia ada response maka dia akan kejeda si proses 2, dan seterusnya
...
function fetchImage(){
    ...
    fetch('/images/wong.png').then((response)=>{
        return response;
    }).then((text)=>{
        console.log('Request sucess', text);
    }).then((err)=>{
